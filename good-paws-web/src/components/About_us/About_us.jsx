...
export const About_us = () => {
  return (
    <Container>
      <Title mx="0px" weight="600">
        ¿Qué sómos?
      </Title>
      <SubtitleWraper>
        <Subtitle weight="500" size="20px" height="30px">
          Somos un proyecto Open Source, destinado a ayudar a las protectoras
          para que puedan realizar su trabajo más cómodamente.
        </Subtitle>
      </SubtitleWraper>
        ...
        <Wrapper>
          <Features>
            ...
            <Subtitle weigth="400" size="16px" height="24px" align="center">
              Somos un proyecto desarrollado por OpenDevs, sin ánimo de lucro y
              100% gratuito.
            </Subtitle>
          </Features>
          ...
          <Features>
            ...
            <Subtitle weigth="400" size="16px" height="24px">
              Ayudamos a que todos los animales encuentren un hogar donde ser
              felices.
            </Subtitle>
          </Features>
          ...
          <Features>
            ...
            <Subtitle weigth="400" size="16px" height="24px">
              Le damos a las protectoras las herramientas que necesitan para
